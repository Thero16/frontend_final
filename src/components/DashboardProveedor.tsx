...
const DashboardProveedor = () => {
  ...
  useEffect(() => {
    const fetchOrganos = async () => {
      try {
        const response = await fetch("https://backend-organos.vercel.app/organos-disponibles", {
          method: "GET",
          headers: {
  ...
  const handleAgregarGarantia = async (idOrgano: number) => {
    try {
      const response = await fetch(`https://backend-organos.vercel.app/organos-disponibles/${idOrgano}/garantia`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      const updatedOrganos = await fetch("https://backend-organos.vercel.app/organos-disponibles", {
  ...
  const handleDeleteOrgano = async (idOrgano: number) => {
    try {
      const response = await fetch(`https://backend-organos.vercel.app/organos-disponibles/${idOrgano}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
